...
export const getClientAPI = (token) => (dispatch) => {
  ...
  return axios
    .get("https://secure-castle-44995.herokuapp.com/client", {
      headers: {
...
export const createClientAPI = (client,token) => (dispatch) => {
  ...
  return axios.post("https://secure-castle-44995.herokuapp.com/client",client, {
    headers: {
      Authorization: "Bearer " + token,
    },
  });
...
export const updateClientAPI = (id, updated_client, token) => (dispatch) => {
  return axios.patch(
    `https://secure-castle-44995.herokuapp.com/client/${id}`,
    updated_client,
    {
      headers: {
        Authorization: "Bearer " + token,
